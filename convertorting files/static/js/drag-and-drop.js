...
function initDocumentDragAndDrop() {
    ...
    async function handleDrop(e) {
        ...
        try {
            ...
            if (window.fetchDocumentList && typeof window.fetchDocumentList === 'function') {
                window.fetchDocumentList();
            } else {
                console.error('fetchDocumentList function not found in global scope');
            }
...
function initFileUploadDragAndDrop() {
    ...
    function handleDrop(e) {
        ...
        if (files.length > 0) {
            ...
            if (uploadStatus) {
                uploadStatus.innerHTML = `Vybrané soubory: ${files.length}`;
